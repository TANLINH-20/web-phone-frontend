...
class Wishlist extends Component {
    ...
    getWishlist(pageNumber) {
        ...
        axios.get(`http://127.0.0.1:8000/api/product/wishlist?page=${pageNumber}`, {
    ...
    handleDelete(e) {
        ...
        axios.delete(`http://127.0.0.1:8000/api/product/wishlist/${id}`, {
            headers: { Authorization: `Bearer ${localStorage.getItem('token')}`}
        }).then(response => {
                                ...
                                <tbody>
                                    { localStorage.getItem('token') ?
                                        ...
                                        this.state.wishlist.length > 0 && this.state.wishlist.map(item => (
                                            <tr key={item.id}>
                                                <td><img height="100" width="100" src={`${urlImage}/${JSON.parse(item.product.photo)[0]}`} alt={JSON.parse(item.product.photo)[0]} /></td>
                                                <td>
                                                ...
                                                <td style={{textAlign: "center"}}>{item.stock > 0 ? 'Avaiable' : 'Not Avaiable'}</td>
                                    ...
                                    <tr>
                                        <td colSpan="6" className='py-5 text-center'><h5>Please login to be able to add or view products in your wishlist!</h5></td>
                                    </tr>}
                                </tbody>
                            </table>
